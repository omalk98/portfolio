    ...
    >
      <div className='relative flex w-full flex-1 scale-y-125 justify-center isolate z-0 translate-y-[75px] md:translate-y-[100px]'>
        <motion.div
          ...
          className='absolute inset-auto right-1/2 h-56 w-[30rem] bg-gradient-conic from-yellow-500 dark:from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]'
        >
        ...
        <motion.div
          ...
          className='absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-yellow-500 dark:to-cyan-500 text-white [--conic-position:from_270deg_at_center_top]'
        >
